...
void Editor::move_up() {cursor.move_left(bytes_per_row);}
void Editor::move_down() {cursor.move_right(bytes_per_row);}

void Editor::delete_symbol() {buffer.erase_byte(cursor.get_position());}
